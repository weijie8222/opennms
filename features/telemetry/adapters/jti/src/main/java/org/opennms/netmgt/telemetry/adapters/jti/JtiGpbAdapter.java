 ...
 *
 * Messages are decoded using the corresponding classes generated by
 * the Google Protobuf definitions and forwarded to a script
...
public class JtiGpbAdapter extends AbstractPersistingAdapter {
    ...
    private final ThreadLocal<ScriptedCollectionSetBuilder> scriptedCollectionSetBuilders =
            new ThreadLocal<ScriptedCollectionSetBuilder>() {
                @Override protected ScriptedCollectionSetBuilder initialValue() {
                    try {
    ...
    public Optional<CollectionSetWithAgent> handleMessage(TelemetryMessageDTO message, TelemetryMessageLogDTO messageLog) throws Exception {
        ...
        try {
            ...
            if (nodeId >= 0) {
                ...
                agent = collectionAgentFactory.createCollectionAgent(Integer.toString(nodeId), inetAddress);
            }
