    ...
    */
    $scope.quickAddNode = function() {
      ...
      var modalInstance = $uibModal.open({
        ...
        templateUrl: 'angular-app/components/admin/requisition/viewsquick-add-node.html',
        size: 'lg',
        resolve: {
    ...
    */
    $scope.clone = function(foreignSource) {
      ...
      var modalInstance = $uibModal.open({
        ...
        templateUrl: 'angular-app/components/admin/requisition/viewsclone-foreignsource.html',
        resolve: {
