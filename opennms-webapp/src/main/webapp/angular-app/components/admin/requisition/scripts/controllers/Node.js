...
(function() {
  ...
  * @ngdoc controller
  * @name NodeController
  * @module onms.ui.admin.requisition
  *
  ...
  .controller('NodeController', ['$scope', '$routeParams', '$cookies', '$location', '$uibModal', 'RequisitionsService', 'growl', function($scope, $routeParams, $cookies, $location, $uibModal, RequisitionsService, growl) {
    ...
    */
    $scope.goBack = function() {
      $scope.goTo('#admin/requisitions/' + encodeURIComponent($scope.foreignSource));
    };
    ...
    */
    $scope.goVerticalLayout = function() {
      ...
      $scope.goTo('#admin/requisitions/' + encodeURIComponent($scope.foreignSource) + '/nodes/' + encodeURIComponent($scope.foreignId) + '/vertical');
    };
    ...
    */
    $scope.goHorizontalLayout = function() {
      ...
      $scope.goTo('#admin/requisitions/' + encodeURIComponent($scope.foreignSource) + '/nodes/' + encodeURIComponent($scope.foreignId));
    };
    ...
    */
    $scope.editAsset = function(index, isNew) {
      ...
      var modalInstance = $uibModal.open({
        ...
        templateUrl: 'angular-app/components/admin/requisition/viewsasset.html',
        resolve: {
    ...
    */
    $scope.editInterface = function(index, isNew) {
      ...
      var modalInstance = $uibModal.open({
        ...
        templateUrl: 'angular-app/components/admin/requisition/viewsinterface.html',
        resolve: {
